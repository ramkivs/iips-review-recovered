# IES-015 — Technology Compatibility Statement
...
|---|---|
| IES-015 v1.0 (methodology, D15 v1.3) | Platform v1.x |
| Calibration Profile 1.0 | Engine v1.0 |
| Reference Assets 1.0 | IES-015 v1.0 |
| Validation Suite 1.0 | Reference Assets 1.0 |
| Ontology Metadata 1.0 | CSIP (zero change) |

## 2. Platform compatibility

- IES-015 requires **no platform change** — reuses IES-005 runtime/framework/contracts/replay/evidence.
...
- Coexists with Banking (IES-006), Insurance (IES-007), Capital Markets (IES-008), Healthcare (IES-009), Hospitality (IES-010), Energy (IES-011), Utilities (IES-012), Consumer (IES-013), Industrials (IES-014).
...
| Banking/Insurance/Capital Markets/Healthcare/Hospitality/Energy/Utilities/Consumer/Industrials engines | 0 |
| CSIP capability | 0 |
...
IES-015 v1.0 is compatible with Platform v1.x and coexists with the nine released sector engines + CSIP, with zero platform, framework, engine, or CSIP modification.

## 6. Reuse

Reusable format for all future sector standards (IES-016+).
