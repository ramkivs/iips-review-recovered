# IES-017 16 IMPLEMENTATION READINESS CERTIFICATE
...
# Document 16 - IMPLEMENTATION READINESS CERTIFICATE (IES-017 remediated content)
...
The frozen acceptance matrix gate 1 records: "Pillars match frozen expected outputs (round-half-to-even at 1dp)" - PASS (matrix `ies-017-automobile/AUTOMOBILE_ENGINE_ACCEPTANCE_MATRIX.md` @ `8707125b545d...`; 16 gates all PASS).

Recorded certificate header facts (frozen asset, quoted as recorded): **Contract:** D17 v1.0 (M1–M15 ACCEPTED by the maintainer/domain authority) / **Baseline:** canonical `9bf91d148a8013e0e51bc0d0c22e70894e0dab15`

Frozen anchor cited by DEC-D25 §4 for this engine: AB-001 composite 71.3, verdict Buy (certified replay baseline, fence 7).
...
| --- | --- | --- |
| In-engine readiness certificate (frozen) | ies-017-automobile/IES-017_IMPLEMENTATION_READINESS_CERTIFICATE.md | a1f8ee7f9a7e7bdb572041f9cbbe0357a87bc77f |
| Acceptance matrix | ies-017-automobile/AUTOMOBILE_ENGINE_ACCEPTANCE_MATRIX.md | 8707125b545d36541e1199e3f35d425fdda3613d |
