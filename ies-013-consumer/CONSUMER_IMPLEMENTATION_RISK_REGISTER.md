# IES-013 — Consumer Implementation Risk Register
...
|---|---|---|
| Calibration drift | load from frozen `consumer-calibration-1.0.0` | golden regression (10/10) |
...
| Segment misclassification | segment + business model → profile | validation fixtures (all segments) |
| Brand/quality qualitative ambiguity | Calibration Boundary Review Matrix | replay + fixtures |
...
| Rounding error (round-half-to-even) | normative D15 rounding | golden regression (10/10) |
