...
Governance rules for hospitality reference assets (Phase 3): golden dataset, expected outputs, fixtures, replay dataset.

# 1. Governance rules

- All reference assets are **deterministic + versioned**.
- Frozen assets are immutable; changes require a new version, never mutation.
- Calibration is business-model scoped and versioned (`hospitality-calibration-1.0.0`).
...
**IES-010-D14 · Version 1.0 · Status SPECIFICATION**
