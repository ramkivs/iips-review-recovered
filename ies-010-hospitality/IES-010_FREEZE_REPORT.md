# IES-010 — Freeze Report (v1.0)

**Standard:** IES-010 — Hospitality Sector Engine
**Status:** FROZEN v1.0
**Freeze Date:** 2026-08-08
**Approver:** IIPS Engineering Standards Maintainer
**Release Tag:** `ies-010-v1.0.0`

---

## 1. Freeze scope

IES-010 transitions from Draft to **Frozen v1.0**. See `IES-010_FREEZE_MANIFEST.json` for the machine-readable record (versions + SHA-256 hashes).
...
## 2. Freeze gate (per `IES-010_FREEZE_CHECKLIST.md`)

All 16 items complete.

## 3. Compatibility

Per `IES-010_COMPATIBILITY.md`: IES-010 v1.0 compatible with Platform v1.x; zero platform/framework/engine/CSIP modification; CSIP ontology compatible.

## 4. Regression baseline

See `IES-010_FREEZE_REGRESSION_BASELINE.md` — the implementation target (9 frozen outputs + 9 fixtures + override paths).
