# D7-TIER3-PARITY - P2 SUBSTANTIVE DOCUMENT REVIEW - IES-017 Automobile

- Date: 2026-09-05 (Asia/Calcutta).
- Artifact class: P2 SUBSTANTIVE DOCUMENT REVIEW record for IES-017 Automobile ONLY, executed under the durably recorded P2 scope/execution authority (governance/iips/D7-TIER3-PARITY-P2-SCOPE-EXECUTION-AUTHORITY-2026-09-05.md at commit 7fa0664f46149cdb75ce60e511c2b5345755926b, artifact SHA-256 d6efe761b9e429ff31a0200b55a072e2ad4d91311fc5ec1de3eeee5e4e25f83e). This record is a REVIEW record: it is NOT certification, grants no authority, authorizes nothing, and does not certify D7-TIER3-PARITY (which remains NOT SATISFIED).
...
## 3. Corpus-level measurements - IES-017 Automobile [ARENA, all first-hand at 830bd7218f6a77274e3d58eef09d706a3a99794f]

- All 19 documents of ies-017-automobile/docs/ were read IN FULL from their pinned blobs. Pinned inventory (slot, document, blob, bytes):
  - IES-017_01_README.md | d6cb13c8398c342a2ca9167ea2d008b5070aff84 | 797 bytes
  - IES-017_02_EXECUTIVE_SUMMARY.md | bc5d7f8ed5f39f40ac8a84ad7b0b931cfcfc26cb | 808 bytes
  - IES-017_03_INDUSTRY_MODEL.md | 766ebe3e66b11b4e79d762400b1ebae92c32d444 | 805 bytes
  - IES-017_04_BUSINESS_MODEL.md | 9c7340cf7cf10f3e378df32aa1ab62ff07822e76 | 805 bytes
  - IES-017_05_METHODOLOGY_PRINCIPLES.md | 240e6f267e916906485cbf490d223a9a40250ff4 | 813 bytes
  - IES-017_06_METRIC_LIBRARY.md | b5f9400d091d5a34509556833a0bc755f9ccbeff | 805 bytes
  - IES-017_07_SCORE_ENGINE.md | 1c29965c794853f22fbbdd1964e62119f6054ac9 | 803 bytes
  - IES-017_08_FORMULA_LIBRARY.md | a50418245950a6a7f5669aea552f9723a5b776ee | 806 bytes
  - IES-017_09_CALIBRATION.md | b6804d6176c3b7569b1591f74e41a31e7ad0c407 | 802 bytes
  - IES-017_10_DECISION_ENGINE.md | 050c15d23d467efb0d667e68e99cbe189b996022 | 806 bytes
  - IES-017_11_EVIDENCE_FRAMEWORK.md | dc6efab58344dae3f5cb96e94345804c0ce72fe9 | 809 bytes
  - IES-017_12_VALIDATION.md | 998b7a3747bd93ee98c023da8cc46b67db27eab7 | 801 bytes
  - IES-017_13_ARENA_IMPLEMENTATION_SPECIFICATION.md | fdd9c63503655fd25a6520a38bee65ae75d8dbae | 825 bytes
  - IES-017_14_REFERENCE_ASSET_GOVERNANCE.md | 9a16525f2168dd2469e1c443d9c3f567d1c2875f | 817 bytes
  - IES-017_15_NORMATIVE_CALCULATION_APPENDIX.md | 2a2e27ea8dbefa008e551cea56b2bf3344f4e424 | 821 bytes
  - IES-017_16_IMPLEMENTATION_READINESS_CERTIFICATE.md | 4ece989d35b2a05ee476bbb61998417e6d31039b | 827 bytes
  - IES-017_17_MASTER_INDEX.md | b1745214436d0f9fcac0e18ef4135be43f6d9a6d | 803 bytes
  - IES-017_18_DATA_DICTIONARY.md | 8e4af0a3bc3dee494a4f72c5cde2134d2d2dda2d | 806 bytes
  - IES-017_19_REFERENCE_DATA_SOURCES.md | 6cc264582a41cae27bfab9ed2c134618bd7a2f0f | 813 bytes
...
- Template verbatim (from IES-017_09_CALIBRATION.md, title stripped): the six statements quoted in the previous paragraph; full bytes archived at the pinned blob. Observed characteristic: each committed document begins with a UTF-8 BOM (non-material to parity, recorded as fact).
- DECISIVE MEASUREMENT 2 - required content vs documented content: the frozen assets this engine's documentation set must describe carry, by direct count: calibration JSON = 262 leaf values (top-level keys: archetypeRisk, bandScores, calibratedBandTables, contractVersion, profile, program, segments, standard, verdictMapping, version); golden-reference inputs = 222 leaf values; expected outputs = automobile-golden-reference-1.0.0 = 182 leaf values across 13 cases; ontology metadata = 6 top-level keys; verdict vocabulary = 6 values (Accumulate, Avoid, Buy, Hold, Strong Buy, Watch); 5 subsegments (commercial-vehicles, ev-native, mass-market-oem, premium-oem, tier-1-supplier); 5 archetypes (commercial, component-supplier, ev-pure-play, full-line, luxury). Documented in the 19-document set: 0 (zero) of all of these.
...
- Context (scoped correctly): substantive engine documentation DOES exist elsewhere in this engine's frozen asset chain (discovery pack 13841 bytes; acceptance matrix; in-engine readiness certificate; the calibration/golden/expected/replay JSONs; generator) - P1 verified those chains. The deficiency established by this review is specifically and only that the NINETEEN-DOCUMENT ENGINEERING SET carries no substantive content: the parity invariant (DEC-D14: "19 numbered documents + ARCHITECTURE_REVIEW") is satisfied structurally but not substantively, exactly the distinction Decision C recorded as binding.

## 4. Per-document findings - IES-017 Automobile (19 documents x R1-R6 + class check)

### IES-017_01_README.md
- Slot / class: 01_README.md (Governance / index) | Pinned blob d6cb13c8398c342a2ca9167ea2d008b5070aff84 | 797 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
...
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
...
### IES-017_02_EXECUTIVE_SUMMARY.md
- Slot / class: 02_EXECUTIVE_SUMMARY.md (Overview) | Pinned blob bc5d7f8ed5f39f40ac8a84ad7b0b931cfcfc26cb | 808 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_03_INDUSTRY_MODEL.md
- Slot / class: 03_INDUSTRY_MODEL.md (Domain model) | Pinned blob 766ebe3e66b11b4e79d762400b1ebae92c32d444 | 805 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_04_BUSINESS_MODEL.md
- Slot / class: 04_BUSINESS_MODEL.md (Domain model) | Pinned blob 9c7340cf7cf10f3e378df32aa1ab62ff07822e76 | 805 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_05_METHODOLOGY_PRINCIPLES.md
- Slot / class: 05_METHODOLOGY_PRINCIPLES.md (Methodology) | Pinned blob 240e6f267e916906485cbf490d223a9a40250ff4 | 813 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_06_METRIC_LIBRARY.md
- Slot / class: 06_METRIC_LIBRARY.md (Quantitative core) | Pinned blob b5f9400d091d5a34509556833a0bc755f9ccbeff | 805 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_07_SCORE_ENGINE.md
- Slot / class: 07_SCORE_ENGINE.md (Engine logic) | Pinned blob 1c29965c794853f22fbbdd1964e62119f6054ac9 | 803 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_08_FORMULA_LIBRARY.md
- Slot / class: 08_FORMULA_LIBRARY.md (Quantitative core) | Pinned blob a50418245950a6a7f5669aea552f9723a5b776ee | 806 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_09_CALIBRATION.md
- Slot / class: 09_CALIBRATION.md (Calibration) | Pinned blob b6804d6176c3b7569b1591f74e41a31e7ad0c407 | 802 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_10_DECISION_ENGINE.md
- Slot / class: 10_DECISION_ENGINE.md (Engine logic) | Pinned blob 050c15d23d467efb0d667e68e99cbe189b996022 | 806 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_11_EVIDENCE_FRAMEWORK.md
- Slot / class: 11_EVIDENCE_FRAMEWORK.md (Evidence / validation) | Pinned blob dc6efab58344dae3f5cb96e94345804c0ce72fe9 | 809 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_12_VALIDATION.md
- Slot / class: 12_VALIDATION.md (Evidence / validation) | Pinned blob 998b7a3747bd93ee98c023da8cc46b67db27eab7 | 801 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_13_ARENA_IMPLEMENTATION_SPECIFICATION.md
- Slot / class: 13_ARENA_IMPLEMENTATION_SPECIFICATION.md (Implementation / ontology) | Pinned blob fdd9c63503655fd25a6520a38bee65ae75d8dbae | 825 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_14_REFERENCE_ASSET_GOVERNANCE.md
- Slot / class: 14_REFERENCE_ASSET_GOVERNANCE.md (Asset governance) | Pinned blob 9a16525f2168dd2469e1c443d9c3f567d1c2875f | 817 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_15_NORMATIVE_CALCULATION_APPENDIX.md
- Slot / class: 15_NORMATIVE_CALCULATION_APPENDIX.md (Quantitative core) | Pinned blob 2a2e27ea8dbefa008e551cea56b2bf3344f4e424 | 821 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_16_IMPLEMENTATION_READINESS_CERTIFICATE.md
- Slot / class: 16_IMPLEMENTATION_READINESS_CERTIFICATE.md (Readiness) | Pinned blob 4ece989d35b2a05ee476bbb61998417e6d31039b | 827 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_17_MASTER_INDEX.md
- Slot / class: 17_MASTER_INDEX.md (Governance / index) | Pinned blob b1745214436d0f9fcac0e18ef4135be43f6d9a6d | 803 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
### IES-017_18_DATA_DICTIONARY.md
- Slot / class: 18_DATA_DICTIONARY.md (Data) | Pinned blob 8e4af0a3bc3dee494a4f72c5cde2134d2d2dda2d | 806 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
- R5 Traceability - UNVERIFIABLE. Observed: the document contains zero normative or quantitative claims whose traceability could be assessed.
- R6 Labelling/status compliance - PASS. Observed: the template's labelling is truthful and complete for what the document IS: provenance-explicit NEW work under D36; explicit not-recovered statement; explicit no-independence statement; explicit certification boundary (no A2->A1, no IVM, no certification, no release/tag); no misrepresentation of its own status.
- CLASS CHECK (Data) - FAIL. Authorized check: "Dictionary fields consistent with actual JSON field inventory (golden/expected/replay)." Measured outcome: required content absent - 0 of the required 222 golden + 182 expected leaf fields to dictionary. The document does not satisfy its slot's content requirement under the unchanged A1 parity standard (exemplar slot carries substantive content; see Sec. 3). This FAIL is a measured deficiency, not an inference.
- Document rollup: FAIL (content requirement unmet; R1/R6 PASS; R2-R5 UNVERIFIABLE).

### IES-017_19_REFERENCE_DATA_SOURCES.md
- Slot / class: 19_REFERENCE_DATA_SOURCES.md (Data) | Pinned blob 6cc264582a41cae27bfab9ed2c134618bd7a2f0f | 813 bytes (template only, measured) | Ref 830bd7218f6a77274e3d58eef09d706a3a99794f
- R1 Identity/slot conformance - PASS. Observed: document exists exactly at its pinned blob at the pinned ref; occupies exactly its D14 nineteen-document slot; provenance labelling truthful and D36-compliant (NEW, authority cited, not-recovered statement present). Requirement met on directly observed identity facts.
- R2 Internal consistency - UNVERIFIABLE. Observed: the document contains zero substantive specification content; the evidence class R2 assesses (the document's own substantive claims) is absent, so internal consistency of the specification cannot be established. Not a vacuous PASS (W5).
- R3 Frozen-asset consistency - UNVERIFIABLE. Observed: the document makes zero checkable claims against the frozen assets (calibration 262 leaf values, golden 222, expected 182); no claims exist to contradict or confirm. Registered alongside the class-check FAIL below, which carries the substantive content deficiency.
- R4 Methodology alignment - UNVERIFIABLE. Observed: the document states zero methodology content to align (or misalign) with the D25-ACCEPTed engine methodology or the unchanged A1 methodology (W8).
...
## 5. Findings rollup - IES-017 Automobile
...
## 6. Engine-level P2 verdict - IES-017 Automobile

**REJECT (P2 substantive-review level): DOCUMENTATION PARITY NOT ESTABLISHED.** The nineteen-document engineering set of IES-017 Automobile does not carry the substantive content the unchanged A1 parity standard requires: all 19 slots fail their class-specific content requirements (measured 0-of-N; single provenance template corpus-wide; A1 exemplar form carries substantive content in every slot). This verdict is a review finding only: it is NOT certification of anything, NOT a parity determination, NOT a status change - the engine remains Class A, maturity A2, and D7-TIER3-PARITY remains NOT SATISFIED. Remediation (authoring the 57 substantive documents across engines) is PRODUCT MUTATION and is NOT authorized by P2 (Sec. 7 exclusions; read-only execution); it would require a separate authority decision.
