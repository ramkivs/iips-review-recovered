# IES-020 — Independent Verification Report
...
The IES-020 share of that execution is the four regression kinds below. The SHA-256 values
...
|---|---|---|:-:|---|
| 1 | acceptance | `tests/regression/materials-metals-acceptance.test.ts` | 13 | `705e459d4af95e943a2d06e4aadebf2b89401b9fc0f7ffe07ac0c1cd1a097757` |
| 2 | framework-integration | `tests/regression/materials-metals-framework-integration.test.ts` | 7 | `7cc13c1c178c33e715495d002c7fbec4ede493fe6fbb72467f4e8ecb85367bd9` |
| 3 | reuse-verification | `tests/regression/materials-metals-reuse-verification.test.ts` | 4 | `d360930970dbce9cd85bc67b40cb408a1060c3a974a3ebcddf0f5847e5857a14` |
| 4 | wp4-validation | `tests/regression/materials-metals-wp4-validation.test.ts` | 5 | `7daa7da3afbc6fe408ae15f63fc311ec6daff63977698bbd2ccc4f8a648307be` |

The other eight files in the same command are the corresponding four kinds for IES-016 and IES-017;
...
| IES-017 | acceptance | `tests/regression/automobile-acceptance.test.ts` | 13 | `35d8f133beb6df7a90ee06bbd272d52ed8f3690c95acdb545b2dabcd79bb0a87` |
| IES-017 | framework-integration | `tests/regression/automobile-framework-integration.test.ts` | 7 | `188b8a281609ee2bc3a7515c75773fb0b7dc8d8956527f93fd7b9aeebd2480a4` |
| IES-017 | reuse-verification | `tests/regression/automobile-reuse-verification.test.ts` | 4 | `c52b2ad6cc7d75c0ffb389c3d3cbc4771774bf0d11416eec7fa663ad127b62bc` |
| IES-017 | wp4-validation | `tests/regression/automobile-wp4-validation.test.ts` | 5 | `b3f8e695e5103ed16e3ee63142edc56650dd893daf66e0f2e477e72954f2effc` |
...
the six D28 files were uncommitted at that instant). It reported `tsc --noEmit` PASS, IES-020
...
relief as the kinds missing for IES-020 under the D5-S1 four-kind requirement; they were
...
Golden-reference anchor reproduced by these tests: **MM-001 → composite 82.5, verdict "Strong Buy"**,
taken from the frozen `materials-metals-expected-outputs-1.0.0.json` oracle rather than asserted
independently of it.
...
`IES-020_FREEZE_MANIFEST.json` at `ff1c90e` carries twelve `documentHashes` entries plus a
...
- **Architecture review: a document exists; no organisational review.** `IES-020_ARCHITECTURE_REVIEW.md`
...
- **Engineering-document set: documents exist; content not verified.** The
  `docs/IES-020_01_README.md` .. `docs/IES-020_19_REFERENCE_DATA_SOURCES.md` set now exists, created
...
- **Evidence maturity is unchanged.** This report does not promote IES-020 from A2 to
...
2026-09-02 execution recorded above, the IES-020 engine implementation on `phase13-next` @
