...
The IES-016 share of that execution is the four regression kinds below. The SHA-256 values
...
|---|---|---|:-:|---|
| 1 | acceptance | `tests/regression/telecommunications-acceptance.test.ts` | 13 | `2bf45b69cf58fd89c86cc8559bcb0801a37e2b2ca76acbe62808864d5de8ebf1` |
| 2 | framework-integration | `tests/regression/telecommunications-framework-integration.test.ts` | 7 | `ded96a3929bfd583ab1099c28b28979c2a9a471432e920ea0b1951c9a07a3b61` |
| 3 | reuse-verification | `tests/regression/telecommunications-reuse-verification.test.ts` | 4 | `d8ec7b9411b72dad08aea162eada516f6ea07dc6e61728748ea604bbd49852a1` |
| 4 | wp4-validation | `tests/regression/telecommunications-wp4-validation.test.ts` | 5 | `60aa5d1e5c796bc7eaf4599d46000c5359f298e2591b8e646e1ebfa8042a4fc1` |

The other eight files in the same command are the corresponding four kinds for IES-017 and IES-020;
...
the six D28 files were uncommitted at that instant). It reported `tsc --noEmit` PASS, IES-016
...
relief as the kinds missing for IES-016 under the D5-S1 four-kind requirement; they were
...
`IES-016_FREEZE_MANIFEST.json` at `ff1c90e` carries twelve `documentHashes` entries plus a
...
- **Architecture review: a document exists; no organisational review.** `IES-016_ARCHITECTURE_REVIEW.md`
...
- **Engineering-document set: documents exist; content not verified.** The
  `docs/IES-016_01_README.md` .. `docs/IES-016_19_REFERENCE_DATA_SOURCES.md` set now exists, created
...
2026-09-02 execution recorded above, the IES-016 engine implementation on `phase13-next` @
