/**
 * Technology Calibration Loader (WP-3) — loads frozen calibration profile (immutable, external).
 * The frozen profile carries baseline bandScores, per-subsegment calibrated band tables
 * (boundaries + scores together), subsegment weights + leverage alerts, archetype risk
 * multipliers, and the verdict mapping. All immutable via deepFreeze.
 */
import { deepFreeze } from '../../../infrastructure/deepFreeze';
import calibrationProfile from '../technology-calibration-1.0.0.json';
...
export interface TechnologyCalibrationProfile {
...
export function loadTechnologyCalibration(): TechnologyCalibrationProfile {
