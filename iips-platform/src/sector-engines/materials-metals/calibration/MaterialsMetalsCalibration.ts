/**
 * Materials & Metals Calibration Loader — loads the frozen IES-020 D20 calibration profile
 ...
 *
 * Implements the accepted D20 M6–M15 methodology exactly. No reinterpretation.
 */
...
export interface MaterialsMetalsCalibrationProfile {
...
export function loadMaterialsMetalsCalibration(): MaterialsMetalsCalibrationProfile {
