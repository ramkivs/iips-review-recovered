/**
 * Automobile Calibration Loader — loads the frozen IES-017 D17 calibration profile
 ...
 *
 * Implements the accepted D17 M6–M15 methodology exactly. No reinterpretation.
 */
...
export interface AutomobileCalibrationProfile {
...
export function loadAutomobileCalibration(): AutomobileCalibrationProfile {
