...
export interface HealthcareHarness { plugins: PluginLoader; runtime: RuntimeCoordinator; evidence: EvidencePipeline; store: SnapshotStore; }

export function buildHealthcareHarness(): HealthcareHarness {
