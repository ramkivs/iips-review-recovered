# IES-020 — Final Readiness Certificate (Tier-3, Role-Separated Evidence)

**Standard:** IES-020 — Materials & Metals Sector Engine
**Engine:** `sector.materials-metals`
...
regression files below are the IES-020 share of a single twelve-file execution (section 3).

| Evidence | Path | Commit | SHA-256 |
|---|---|---|---|
| Independent-verification report (refreshed, current) | `iips-platform/IES020_INDEPENDENT_VERIFICATION_REPORT.md` | `245be839` | `1bc164aae627bc8b9331d82b8df0841e9b544b4ac1109b4396a5f87c2aa33462` |
| Freeze manifest (refreshed; `status` FROZEN; `releaseTag` null) | `ies-020-materials-metals/IES-020_FREEZE_MANIFEST.json` | `245be839` | `648f26633ad87f9cd1f79185aba517bee8187c390e273663a0674603c84d6f60` |
| Regression test (acceptance, 13 subtests) | `iips-platform/tests/regression/materials-metals-acceptance.test.ts` | `245be839` | `705e459d4af95e943a2d06e4aadebf2b89401b9fc0f7ffe07ac0c1cd1a097757` |
| Regression test (framework-integration, 7 subtests) | `iips-platform/tests/regression/materials-metals-framework-integration.test.ts` | `245be839` | `7cc13c1c178c33e715495d002c7fbec4ede493fe6fbb72467f4e8ecb85367bd9` |
| Regression test (reuse-verification, 4 subtests) | `iips-platform/tests/regression/materials-metals-reuse-verification.test.ts` | `245be839` | `d360930970dbce9cd85bc67b40cb408a1060c3a974a3ebcddf0f5847e5857a14` |
| Regression test (wp4-validation, 5 subtests) | `iips-platform/tests/regression/materials-metals-wp4-validation.test.ts` | `245be839` | `7daa7da3afbc6fe408ae15f63fc311ec6daff63977698bbd2ccc4f8a648307be` |
...
| Implementation-readiness certificate — evidence only — not the final-readiness instrument | `ies-020-materials-metals/IES-020_IMPLEMENTATION_READINESS_CERTIFICATE.md` | `245be839` | `63222a258964079d844efa8c8c0aca20a4e4b0371a079a2cba4d0dd4b439bd37` |
| D36 documentation set — new documentation, self-labelled, not recovered review evidence | `ies-020-materials-metals/docs/IES-020_01_README.md` .. `ies-020-materials-metals/docs/IES-020_19_REFERENCE_DATA_SOURCES.md`, `ies-020-materials-metals/IES-020_ARCHITECTURE_REVIEW.md`, `ies-020-materials-metals/D20_AUTHORITY_REVIEW.md` | `0a8e287` | per manifest `documentHashes` (`architectureReview`, `authorityReview`) |
...
| IES-020 (4 files) | 29 subtests, 29 pass |
...
| 2 | Golden-reference anchor reproduced by the acceptance test: **MM-001 → composite 82.5, verdict "Strong Buy"**, taken from the frozen `materials-metals-expected-outputs-1.0.0.json` oracle rather than asserted independently of it | ESTABLISHED |
...
- **`D7-TIER3-PARITY` — OPEN.** `IES-020_ARCHITECTURE_REVIEW.md` is a D36 header-only stub, not a
...
- **IES-020 aluminium placement.** The aluminium-placement item recorded at `DEC-D25-TIER3-EVIDENTIARY-STANDARD` section 9 remains OPEN; it was out of scope for the verification evidence above.

## 6. Non-promotion statement

- IES-020 **remains A2**; its evidence maturity is unchanged by this certificate.
...
DEC-A2-A1-CLOSURE-STRATEGY section 5 has been filled for IES-020 under a role-separated model, on the
