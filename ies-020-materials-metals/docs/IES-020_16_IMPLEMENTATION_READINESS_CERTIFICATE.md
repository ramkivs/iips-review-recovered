# IES-020 AUTHORITY REVIEW.md 16 IMPLEMENTATION READINESS CERTIFICATE
...
# Document 16 - IMPLEMENTATION READINESS CERTIFICATE (IES-020 remediated content)
...
The frozen acceptance matrix gate 1 records: "Pillars match frozen expected outputs (round-half-to-even at 1dp)" - PASS (matrix `ies-020-materials-metals/MATERIALS_METALS_ENGINE_ACCEPTANCE_MATRIX.md` @ `12a04073ff03...`; 16 gates all PASS).

Recorded certificate header facts (frozen asset, quoted as recorded): **Contract:** D20 v1.0 (M1–M15 ACCEPTED by the maintainer/domain authority) / **Baseline:** canonical `d51b120b2ac8a524bf088ed8fe80b904c29a628b`

Frozen anchor cited by DEC-D25 §4 for this engine: MM-001 composite 82.5, verdict Strong Buy (certified replay baseline, fence 7).
...
| --- | --- | --- |
| In-engine readiness certificate (frozen) | ies-020-materials-metals/IES-020_IMPLEMENTATION_READINESS_CERTIFICATE.md | 7533e1d69dfd32b1f2781680e885e536a714f180 |
| Acceptance matrix | ies-020-materials-metals/MATERIALS_METALS_ENGINE_ACCEPTANCE_MATRIX.md | 12a04073ff0334bb3fe7ca6c1c0b8325da79059c |
