...
# Document 17 - MASTER INDEX (IES-016 remediated content)

## 1. Exact 19-document inventory (names and order)

| # | Exact filename | Class | Scope |
| --- | --- | --- | --- |
| 01 | `IES-016_01_README.md` | Governance / index | Engine identity, document map, asset directory, status |
| 02 | `IES-016_02_EXECUTIVE_SUMMARY.md` | Overview | Frozen oracle results, verdict distribution (Accumulate: 4; Avoid: 1; Buy: 4; Hold: 1; Strong Buy: 1; Watch: 2), A2 summary limits |
| 03 | `IES-016_03_INDUSTRY_MODEL.md` | Domain model | Subsegment taxonomy (cable-mso, converged-telco, fixed-broadband, tower-infra, wireless-mno) + archetype taxonomy vs golden-declared values |
| 04 | `IES-016_04_BUSINESS_MODEL.md` | Domain model | Pillar structure, segment weights, archetype risk |
| 05 | `IES-016_05_METHODOLOGY_PRINCIPLES.md` | Methodology | Methodology principles + D25/freeze vs historical pack labels (pack §4) |
| 06 | `IES-016_06_METRIC_LIBRARY.md` | Quantitative core | Metric taxonomy, band tables, flags, pillar membership |
| 07 | `IES-016_07_SCORE_ENGINE.md` | Engine logic | Scoring pipeline, resolution, effective tables, oracle |
| 08 | `IES-016_08_FORMULA_LIBRARY.md` | Quantitative core | Band/renorm/pillar/composite/rounding/min-rank formulas |
| 09 | `IES-016_09_CALIBRATION.md` | Calibration | Calibration field-for-field (all 262 leaves) |
| 10 | `IES-016_10_DECISION_ENGINE.md` | Engine logic | Verdict bands, override vocabulary, precedence, frozen instances |
| 11 | `IES-016_11_EVIDENCE_FRAMEWORK.md` | Evidence / validation | Evidence package, D15, confidence decisions, evidence classes |
| 12 | `IES-016_12_VALIDATION.md` | Evidence / validation | 13-case set (basis telecommunications-golden-reference-1.0.0), fixtures, replay structure, acceptance gates |
| 13 | `IES-016_13_ARENA_IMPLEMENTATION_SPECIFICATION.md` | Implementation / ontology | Ontology metadata, CSIP registration, Q5 UNVERIFIABLE, integration boundary |
| 14 | `IES-016_14_REFERENCE_ASSET_GOVERNANCE.md` | Asset governance | Freeze manifest pinmap, hashNormalization, provenance classes |
| 15 | `IES-016_15_NORMATIVE_CALCULATION_APPENDIX.md` | Quantitative core | Anchor worked calculation (TC-001: 77.8 Buy) + 13/13 reproduction table |
| 16 | `IES-016_16_IMPLEMENTATION_READINESS_CERTIFICATE.md` | Readiness | Frozen recorded readiness evidence (registrations 10 -> 11) + labelling |
| 17 | `IES-016_17_MASTER_INDEX.md` | Governance / index | This index |
| 18 | `IES-016_18_DATA_DICTIONARY.md` | Data | Field inventories of golden/expected/replay/fixtures |
| 19 | `IES-016_19_REFERENCE_DATA_SOURCES.md` | Data | Source register + data-authority reconciliation |
...
| Artifact | Path |
| --- | --- |
| Discovery pack | ies-016-telecommunications/TELECOMMUNICATIONS_DISCOVERY_PACK.md |
| Calibration | ies-016-telecommunications/calibration/telecommunications-calibration-1.0.0.json |
| Golden reference | ies-016-telecommunications/fixtures/telecommunications-golden-reference-1.0.0.json |
| Expected outputs | ies-016-telecommunications/expected-outputs/telecommunications-expected-outputs-1.0.0.json |
| Replay dataset | ies-016-telecommunications/replay-datasets/telecommunications-replay-dataset-1.0.0.json |
| Validation fixtures | ies-016-telecommunications/fixtures/telecommunications-validation-fixtures-1.0.0.json |
| Ontology metadata | ies-016-telecommunications/telecommunications-ontology-metadata-1.0.0.json |
| Freeze manifest | ies-016-telecommunications/IES-016_FREEZE_MANIFEST.json |
| Acceptance matrix | ies-016-telecommunications/TELECOMMUNICATIONS_ENGINE_ACCEPTANCE_MATRIX.md |
| Readiness certificate | ies-016-telecommunications/IES-016_IMPLEMENTATION_READINESS_CERTIFICATE.md |
| Generator | ies-016-telecommunications/contract-tests/generate_expected_outputs.py |
| ARCHITECTURE_REVIEW stub (D36 header-only; unchanged; never a recovered review - W4) | ies-016-telecommunications/IES-016_ARCHITECTURE_REVIEW.md |
...
| --- | --- |
| Methodology | D16 v1.0, ACCEPT under DEC-D25 (fresh; A2) |
| Frozen assets | calibration telecommunications-calibration-1.0.0; golden telecommunications-golden-reference-1.0.0; expected telecommunications-expected-outputs-1.0.0; replay telecommunications-replay-dataset-1.0.0; fixtures telecommunications-validation-fixtures-1.0.0 |
| Case family | TC-001..TC-013 + edge TC-014/TC-015 |
| Anchor case | TC-001 composite 77.8, verdict Buy |
| Verdict distribution (13 cases) | Accumulate: 4; Avoid: 1; Buy: 4; Hold: 1; Strong Buy: 1; Watch: 2 |
| Leaf counts cal/golden/expected | 262 / 220 / 180 |
