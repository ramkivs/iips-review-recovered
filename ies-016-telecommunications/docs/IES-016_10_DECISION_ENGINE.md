...
# Document 10 - DECISION ENGINE (IES-016 remediated content)

## 1. Verdict bands (pack §3.8; frozen verdictMapping)
...
## 2. Override vocabulary, caps and triggers (engine-specific; pack §3.9)

| Override id | Cap | Trigger |
| --- | --- | --- |
| `governance` | Avoid | input flag `governance` |
| `regulatory-risk` | Watch | input flag `regulatoryRisk` |
| `competition-pressure` | Watch | input flag `competitionPressure` |
| `subscriber-collapse` | Watch | input flag `subscriberCollapse` |
...
## 3. Precedence - min-rank (pack §3.9)
...
| --- | --- | --- | --- | --- |
| TC-006 | 60.5 | Accumulate | leverage-breach, competition-pressure, margin-compression | Watch |
| TC-011 | 38.6 | Avoid | leverage-breach, governance | Avoid |
...
Cases where leverage-breach fired in the frozen set: TC-006, TC-011.
...
| --- | --- | --- |
| Verdict/override contract | ies-016-telecommunications/TELECOMMUNICATIONS_DISCOVERY_PACK.md | 68aae104dd3a0ccad8122d5770bd8d2c61637ba6 |
| Frozen verdictMapping + alerts | ies-016-telecommunications/calibration/telecommunications-calibration-1.0.0.json | 178160fcbe0a30975c6796ac22c73a9bd03ab91a |
| Frozen override instances | ies-016-telecommunications/expected-outputs/telecommunications-expected-outputs-1.0.0.json | 0d45ffc44df6d61a6f95dac15a12cb6f88be3155 |
